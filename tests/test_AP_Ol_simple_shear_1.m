% Test AnPar method for analytical simple shear example. This applies a constant 
% simple shear deformation for 10 time steps. The numerical result is compared 
% to the (known) analytical solution. 
function test_AP_Ol_simple_shear_1()
